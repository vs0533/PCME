...
namespace PCME.Domain.AggregatesModel.ExaminationRoomPlanAggregates
{
    public class PlanStatus: Enumeration
    {
        ...
        public static PlanStatus SelectStart = new PlanStatus(1, nameof(SelectStart));
        public static PlanStatus SelectFinish = new PlanStatus(2, nameof(SelectFinish));
        public static PlanStatus SignInStart = new PlanStatus(1, nameof(SignInStart));
        public static PlanStatus Over = new PlanStatus(1, nameof(Over));
        public static PlanStatus Close = new PlanStatus(1, nameof(Close));
